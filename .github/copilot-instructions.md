# [SIMPLE PAYMENT LEDGER] Guidelines

* [Product first requirements](../FIRST_REQUIREMENTS.md): Detailed description of the problem statement, core requirements, and submission guidelines for the payment ledger API.
